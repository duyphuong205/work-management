...
public class JwtUtils {
    ...
    public Map<String, Object> generateToken(CustomUserDetails userDetails) {
        ...
        claim.put("role", userInfo.getRole().name());
    ...
    public UserInfo getCurrentUser() {
        ...
        if (authentication == null || !authentication.isAuthenticated()) {
            throw new NullPointerException("Can't get user in context");
        }
        Object principal = authentication.getPrincipal();
        if (!(principal instanceof CustomUserDetails)) {
            throw new NullPointerException("Can't get user principal is not instanceof CustomUserDetails");
        }
    ...
    public Long getCurrentUserId() {
        try {
            ...
            log.warn(">>>Error getCurrentUserId: ", ex);
            return null;
        }
    }
